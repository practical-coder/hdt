...
func runOperationUserCreateUser(cmd *cobra.Command, args []string) error {
	...
	if err, _ := retrieveOperationUserCreateUserDataFlag(params, "", cmd); err != nil {
		return err
	}
	if err, _ := retrieveOperationUserCreateUserForceReloadFlag(params, "", cmd); err != nil {
		return err
	}
	if err, _ := retrieveOperationUserCreateUserTransactionIDFlag(params, "", cmd); err != nil {
		return err
	}
	if err, _ := retrieveOperationUserCreateUserUserlistFlag(params, "", cmd); err != nil {
		return err
	}
	if err, _ := retrieveOperationUserCreateUserVersionFlag(params, "", cmd); err != nil {
		return err
	}
	if dryRun {
...
func registerOperationUserCreateUserParamFlags(cmd *cobra.Command) error {
	if err := registerOperationUserCreateUserDataParamFlags("", cmd); err != nil {
		return err
	}
	if err := registerOperationUserCreateUserForceReloadParamFlags("", cmd); err != nil {
		return err
	}
	if err := registerOperationUserCreateUserTransactionIDParamFlags("", cmd); err != nil {
		return err
	}
	if err := registerOperationUserCreateUserUserlistParamFlags("", cmd); err != nil {
		return err
	}
	if err := registerOperationUserCreateUserVersionParamFlags("", cmd); err != nil {
		return err
	}
	return nil
}

func registerOperationUserCreateUserDataParamFlags(cmdPrefix string, cmd *cobra.Command) error {
...
func registerOperationUserCreateUserForceReloadParamFlags(cmdPrefix string, cmd *cobra.Command) error {
...
func registerOperationUserCreateUserTransactionIDParamFlags(cmdPrefix string, cmd *cobra.Command) error {
...
func registerOperationUserCreateUserUserlistParamFlags(cmdPrefix string, cmd *cobra.Command) error {
...
func registerOperationUserCreateUserVersionParamFlags(cmdPrefix string, cmd *cobra.Command) error {
...
func retrieveOperationUserCreateUserDataFlag(m *user.CreateUserParams, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	retAdded := false
...
func retrieveOperationUserCreateUserForceReloadFlag(m *user.CreateUserParams, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	retAdded := false
...
func retrieveOperationUserCreateUserTransactionIDFlag(m *user.CreateUserParams, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	retAdded := false
...
func retrieveOperationUserCreateUserUserlistFlag(m *user.CreateUserParams, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	retAdded := false
...
func retrieveOperationUserCreateUserVersionFlag(m *user.CreateUserParams, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	retAdded := false
...
func parseOperationUserCreateUserResult(resp0 *user.CreateUserCreated, resp1 *user.CreateUserAccepted, respErr error) (string, error) {
	if respErr != nil {

		var iRespD interface{} = respErr
		respD, ok := iRespD.(*user.CreateUserDefault)
		if ok {
		...
		resp0, ok := iResp0.(*user.CreateUserCreated)
		if ok {
		...
		resp1, ok := iResp1.(*user.CreateUserAccepted)
		if ok {
		...
		resp2, ok := iResp2.(*user.CreateUserBadRequest)
		if ok {
		...
		resp3, ok := iResp3.(*user.CreateUserConflict)
		if ok {
